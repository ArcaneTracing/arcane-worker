...
class FaithfulnessInput(BaseModel):
    """Input type for Faithfulness evaluation."""
...
async def evaluate_faithfulness(
    ...
    Args:
        input_data: FaithfulnessInput containing user_input, response, and retrieved_contexts
    ...
    """
    if llm is None:
        raise ValueError("LLM is required for Faithfulness metric")
